        ...
        <>
            <div style={{ padding: '30px', display: 'flex' }}>
                ...
                <div style={{ padding: '30px' }}>
                    ...
                    <p>I am currently taking part in a 13-week intensive course with tech academy <a className='contactLink' href='https://www.getfutureproof.co.uk/' target={'blank'}>futureproof</a>.</p>
